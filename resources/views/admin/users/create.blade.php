...
<div class="container">
    <div class="d-flex align-items-center gap-2 mb-4">
        ...
        <h1 class="mb-0" style="font-family: 'Bebas Neue', sans-serif; color: #0d3328;">Create User</h1>
    </div>

    <div class="card shamrock-card">
        <div class="card-header shamrock-header">New user</div>
        <div class="card-body">
            <form method="POST" action="{{ route('admin.users.store') }}">
                ...
                <button type="submit" class="btn btn-shamrock">Create user</button>
